...
import { statusDistribution, fuelTypeDistribution, efficiencyDistribution } from "../../data/flare-performance-data"
...
export function FlarePieCharts() {
  return (
    <div className="grid gap-4 md:grid-cols-3">
      <PieChartCard
        title="Flare Status Distribution"
        description="Current operational status of flares"
        data={statusDistribution}
        valueLabel="flares"
      />
      <PieChartCard
        title="Fuel Type Distribution"
        description="Distribution of fuel types across flares"
        data={fuelTypeDistribution}
        valueLabel="flares"
      />
      <PieChartCard
        title="Efficiency Rating Distribution"
        description="Distribution of flare efficiency ratings"
